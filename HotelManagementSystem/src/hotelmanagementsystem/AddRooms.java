...
public class AddRooms extends JFrame implements ActionListener{
    ...
    AddRooms(){
        ...
        available.setBounds(60,130,120,20);
        add(available);
        ...
        status.setBounds(60,180,120,20);
        add(status);
        
        c2=new JComboBox(new String[]{"Cleaned" , "Unclean"});
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        }else if(ae.getSource() == b2){ this.setVisible(false);}
