...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    JButton b1, b2;
    JComboBox c1;
    Choice h1;     //Choice is in awt package, so we don't write ad JChoice
    JRadioButton r1, r2;
    ...
    AddCustomer() {
        ...
        h1 = new Choice();   //Not static drop down as JComboBox
        try {
            conn c = new conn();
            ...
            while (rs.next()) {
                ...
                h1.add(rs.getString("room_number"));

            }

        } catch (Exception e) {
        }
        h1.setBounds(200, 280, 150, 25);
        add(h1);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == b1){
            ...
            String gender = null;
            if(r1.isSelected()){ gender = "Male";}else if(r2.isSelected()){ gender = "Female";}
            String country= t3.getText();
            String room = h1.getSelectedItem();
