...
public class Project extends JFrame implements ActionListener {
    Project(){
        ...
        ImageIcon ic= new ImageIcon(ClassLoader.getSystemResource("icon/substation.jpg"));
        ...
        /* Customer Details */
        m1.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        /*  Meter Details  */
        m2.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        /* Deposit Details */
        m3.setFont(new Font("monospaceed" , Font.PLAIN,12));
       ...
       /* Second Column */
        ...
        /* Pay Bill */
        u1.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        /* Last Bill */
        u3.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        /* Generate Bill */
        r1.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        /* Notepad */
        ut1.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        ut2.setFont(new Font("monospaceed" , Font.PLAIN,12));
        ...
        ut3.setFont(new Font("monospaceed" , Font.PLAIN,12));
